  ...
  if (nrow(sim_event_consensus[[i]][[s]]) > 0){
    for (j in 1:length(sim_event_consensus[[i]][[s]]$node)){
      ...
      if (sim_event_consensus[[i]][[s]][j, "Cdiv"] == 1 | sim_event_consensus[[i]][[s]][j, "Ediv"] == 1 | sim_event_consensus[[i]][[s]][j, "Wdiv"] == 1
          | sim_event_consensus[[i]][[s]][j, "vicariance_CE"] == 1 | sim_event_conspensus[[i]][[s]][j, "vicariance_CW"] == 1 | sim_event_consensus[[i]][[s]][j, "vicariance_EW"] == 1
  ...
  for (i in 1:length(genera)){
    ...
    for (j in 1:nrow(sim_event_consensus[[i]][[s]])){
      if (sim_event_consensus[[i]][[s]]$Ccol[j] > 0){
        ...
        for (k in 1:length(ma)){
          if (Overlap(na.omit(vi), ma[[k]]) != 0){
            event_SIM_plots_genus$Ccol_myr_list_cons[[i]][[s]][k,]$N <- event_SIM_plots_genus$Ccol_myr_list_cons[[i]][[s]][k,]$N + 1
          }}}
      if (sim_event_consensus[[i]][[s]]$Ecol[j] > 0){
        vi <- c(sim_event_consensus[[i]][[s]]$min[j], sim_event_consensus[[i]][[s]]$max[j])
        for (k in 1:length(ma)){
          if (Overlap(na.omit(vi), ma[[k]]) != 0){
            event_SIM_plots_genus$Ecol_myr_list_cons[[i]][[s]][k,]$N <- event_SIM_plots_genus$Ecol_myr_list_cons[[i]][[s]][k,]$N + 1
          }}}
      if (sim_event_consensus[[i]][[s]]$Wcol[j] > 0){
        vi <- c(sim_event_consensus[[i]][[s]]$min[j], sim_event_consensus[[i]][[s]]$max[j])
        for (k in 1:length(ma)){
          if (Overlap(na.omit(vi), ma[[k]]) != 0){
            event_SIM_plots_genus$Wcol_myr_list_cons[[i]][[s]][k,]$N <- event_SIM_plots_genus$Wcol_myr_list_cons[[i]][[s]][k,]$N + 1
          }}}
      if (sim_event_consensus[[i]][[s]]$Cdiv[j] > 0){
        vi <- c(sim_event_consensus[[i]][[s]]$min[j], sim_event_consensus[[i]][[s]]$max[j])
        for (k in 1:length(ma)){
          if (Overlap(na.omit(vi), ma[[k]]) != 0){
            event_SIM_plots_genus$Cdiv_myr_list_cons[[i]][[s]][k,]$N <- event_SIM_plots_genus$Cdiv_myr_list_cons[[i]][[s]][k,]$N + 1
          }}}
      if (sim_event_consensus[[i]][[s]]$Ediv[j] > 0){
        vi <- c(sim_event_consensus[[i]][[s]]$min[j], sim_event_consensus[[i]][[s]]$max[j])
        for (k in 1:length(ma)){
          if (Overlap(na.omit(vi), ma[[k]]) != 0){
            event_SIM_plots_genus$Ediv_myr_list_cons[[i]][[s]][k,]$N <- event_SIM_plots_genus$Ediv_myr_list_cons[[i]][[s]][k,]$N + 1
          }}}
      if (sim_event_consensus[[i]][[s]]$Wdiv[j] > 0){
        vi <- c(sim_event_consensus[[i]][[s]]$min[j], sim_event_consensus[[i]][[s]]$max[j])
        for (k in 1:length(ma)){
          if (Overlap(na.omit(vi), ma[[k]]) != 0){
            event_SIM_plots_genus$Wdiv_myr_list_cons[[i]][[s]][k,]$N <- event_SIM_plots_genus$Wdiv_myr_list_cons[[i]][[s]][k,]$N + 1
          }}}
      if (sim_event_consensus[[i]][[s]]$vicariance_CE[j] > 0){
        vi <- c(sim_event_consensus[[i]][[s]]$min[j], sim_event_consensus[[i]][[s]]$max[j])
        for (k in 1:length(ma)){
          if (Overlap(na.omit(vi), ma[[k]]) != 0){
            event_SIM_plots_genus$vicarianceCE_myr_list_cons[[i]][[s]][k,]$N <- event_SIM_plots_genus$vicarianceCE_myr_list_cons[[i]][[s]][k,]$N + 1
          }}}
      if (sim_event_consensus[[i]][[s]]$vicariance_CW[j] > 0){
        vi <- c(sim_event_consensus[[i]][[s]]$min[j], sim_event_consensus[[i]][[s]]$max[j])
        for (k in 1:length(ma)){
          if (Overlap(na.omit(vi), ma[[k]]) != 0){
            event_SIM_plots_genus$vicarianceCW_myr_list_cons[[i]][[s]][k,]$N <- event_SIM_plots_genus$vicarianceCW_myr_list_cons[[i]][[s]][k,]$N + 1
          }}}
      if (sim_event_consensus[[i]][[s]]$vicariance_EW[j] > 0){
        vi <- c(sim_event_consensus[[i]][[s]]$min[j], sim_event_consensus[[i]][[s]]$max[j])
        for (k in 1:length(ma)){
          if (Overlap(na.omit(vi), ma[[k]]) != 0){
            event_SIM_plots_genus$vicarianceEW_myr_list_cons[[i]][[s]][k,]$N <- event_SIM_plots_genus$vicarianceEW_myr_list_cons[[i]][[s]][k,]$N + 1
          }}}
      if (sim_event_consensus[[i]][[s]]$vicariance_IW[j] > 0){
        vi <- c(sim_event_consensus[[i]][[s]]$min[j], sim_event_consensus[[i]][[s]]$max[j])
        for (k in 1:length(ma)){
          if (Overlap(na.omit(vi), ma[[k]]) != 0){
            event_SIM_plots_genus$vicarianceIW_myr_list_cons[[i]][[s]][k,]$N <- event_SIM_plots_genus$vicarianceIW_myr_list_cons[[i]][[s]][k,]$N + 1
          }}}
