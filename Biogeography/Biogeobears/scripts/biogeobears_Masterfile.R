...
setwd("/Volumes/DROPBOX/Dropbox/BERNAT/PHD/01.HAJAR_MOUNTAINS/COLONIZATION/Biogeography/Mountain_colonization_area_Biogeobears/3_mountain_blocks_2state/")
...
for (i in 1:length(genera)) {
  ...
  tree_sub <- treeio::drop.tip(tree, tips_to_drop$New_name)
...
consensus_statesn <- readRDS("objects/consensus_states.rds")
consensus_probsn <- readRDS("objects/consensus_probs.rds")
...
for (i in 1:length(consensus_states)){
  print(names(consensus_states)[i])
  print("C" %in% consensus_states[[i]])
  print(unique(consensus_states[[i]]))
  print("-------")
}
...
#dispersal_Af2Ar <- list(c("F","F","R"), c("F","R","F"), 
#                        c("F","F","FR"), c("F","FR","F"),
#                        c("F", "FR", "FR"),
#                        c("FE", "FE", "FR"), c("FE", "FR", "FE"),
#                        c("FE", "F", "FR"), c("FE", "FR", "F"),
#                        c("FE", "E", "FR"), c("FE", "FR", "E"),
#                        c("FE", "FE", "RE"), c("FE", "RE", "FE"),
#                        c("FE", "F", "RE"), c("FE", "RE", "F"),
#                        c("FE", "E", "RE"), c("FE", "RE", "E"), 
#                        c("FS", "S", "FR"), c("FS", "FR", "S"),
#                        c("FS", "FS", "FR"), c("FS", "FR", "FS"),
#                        c("FS", "FS", "RS"), c("FS", "RS", "FS"),
#                        c("FS", "F", "RS"), c("FS", "RS", "F"),
#                        c("FS", "FS", "R"), c("FS", "R", "FS")
#)

#names(dispersal_Af2Ar) <- c("Af_Af_Ar", "Af_Ar_Af", "Af_Af_AfAr", "Af_AfAr_Af")
#dispersal_Af2Ar[2]

#dispersal_Ar2Af <- list(c("R","R","F"), c("R","F","R"), 
#                        c("R","R","FR"), c("R","FR","R"),
#                        c("R", "FR", "FR"),
#                        c("R", "RE", "FR"), c("R", "FR", "RE"),
#                        c("RE", "FR", "E"), c("RE", "E", "FR"), 
#                        c("RE", "FR", "R"), c("RE", "R", "FR"),
#                        c("RE", "FR", "RE"), c("RE", "RE", "FR"),
#                        c("RE", "FE", "RE"), c("RE", "RE", "FE"),
#                        c("RE", "FE", "R"), c("RE", "R", "FE"),
#                        c("RE", "FE", "E"), c("RE", "E", "FE"),
#                        c("RS", "FR", "S"), c("RS", "S", "FR"),
#                        c("RS", "FR", "R"), c("RS", "R", "FR"),
#                        c("RS", "FR", "RS"), c("RS", "RS", "FR"),
#                        c("RS", "FS", "RS"), c("RS", "RS", "FS"),
#                        c("RS", "FS", "R"), c("RS", "R", "FS"),
#                        c("RS", "FS", "S"), c("RS", "S", "FS"))
#names(dispersal_Ar2Af) <- c("Ar_Ar_Af", "Ar_Af_Ar", "Ar_Ar_AfAr", "Ar_AfAr_Ar")
...
#names(vicariance) <- c("AfAr_Af_Ar", "AfAr_Ar_Af")

#extirpation_from_Ar <- list(c("FR","FR","F"), c("FR","F","FR"), c("FR","F","F"))
#extirpation_from_Ar <- list(c("FR","F","F"), c("FR", "F", "FE"), c("FR", "FE", "F"),
#                            c("FR", "F", "FS"), c("FR", "FS", "F"))
extirpation_from_Ar <- list(c("FR", "F"), c("FR", "FE"), c("FR", "FS"))
#names(extirpation_from_Ar) <- c("AfAr_AfAr_Af", "AfAr_Af_AfAr", "AfAr_Af_Af")

#extirpation_from_Af <- list(c("FR","FR","R"), c("FR","R","FR"), c("FR","R","R"))
#extirpation_from_Af <- list(c("FR","R","R"), c("FR", "R", "RE"), c("FR", "RE", "R"),
#                            c("FR", "R", "RS"), c("FR", "RS", "R"))
extirpation_from_Af <- list(c("FR", "R"), c("FR", "RE"), c("FR", "RS"))
#names(extirpation_from_Af) <- c("AfAr_AfAr_Ar", "AfAr_Ar_AfAr", "AfAr_Ar_Ar")
...
##### PLOT CONSENSUS #####
# All events
plot(1,type='n',xlim=c(myr,0),ylim=c(0,max(event_all_cons$N)),xlab='Ma', ylab='N', main="All events (consensus)")
# smooth
...
plot(1,type='n',xlim=c(myr,0),ylim=c(0,max(Af2Ar_all_cons$N)),xlab='Ma', ylab='N', main="Africa to Arabia dispersal (consensus)")
# smooth
lines(spline(Af2Ar_all_cons$Ma-1, Af2Ar_all_cons$N), type="l", col="red", lwd=5, pch=16, cex=1)
# not smooth
lines(Af2Ar_all_cons$Ma-1, Af2Ar_all_cons$N, type="l", col="green", lwd=5, pch=16, cex=1)

# Arabia -> Africa dispersal
plot(1,type='n',xlim=c(myr,0),ylim=c(0,max(Ar2Af_all_cons$N)),xlab='Ma', ylab='N', main="Arabia to Africa dispersal (consensus)")
# smooth
lines(spline(Ar2Af_all_cons$Ma-1, Ar2Af_all_cons$N), type="l", col="purple", lwd=5, pch=16, cex=1)
# not smooth
lines(Ar2Af_all_cons$Ma-1, Ar2Af_all_cons$N, type="l", col="purple", lwd=5, pch=16, cex=1)

# Vicariance
plot(1,type='n',xlim=c(myr,0),ylim=c(0,max(vicariance_all_cons$N)),xlab='Ma', ylab='N', main="Vicariance events (consensus)")
# smooth
lines(spline(vicariance_all_cons$Ma-1, vicariance_all_cons$N), type="l", col="gold", lwd=5, pch=16, cex=1)
# not smooth
lines(vicariance_all_cons$Ma-1, vicariance_all_cons$N, type="l", col="gold", lwd=5, pch=16, cex=1)

# Extirpation from Africa
plot(1,type='n',xlim=c(myr,0),ylim=c(0,max(extirp_from_Af_all_cons$N)),xlab='Ma', ylab='N', main="Extirpation from Africa events (consensus)")
# smooth
lines(spline(extirp_from_Af_all_cons$Ma-1, extirp_from_Af_all_cons$N), type="l", col="blue", lwd=5, pch=16, cex=1)
# not smooth
lines(extirp_from_Af_all_cons$Ma-1, extirp_from_Af_all_cons$N, type="l", col="blue", lwd=5, pch=16, cex=1)

# Extirpation from Arabia
plot(1,type='n',xlim=c(myr,0),ylim=c(0,max(extirp_from_Ar_all_cons$N)),xlab='Ma', ylab='N', main="Extirpation from Arabia events (consensus)")
# smooth
lines(spline(extirp_from_Ar_all_cons$Ma-1, extirp_from_Ar_all_cons$N), type="l", col="orange", lwd=5, pch=16, cex=1)
# not smooth
lines(extirp_from_Ar_all_cons$Ma-1, extirp_from_Ar_all_cons$N, type="l", col="orange", lwd=5, pch=16, cex=1)

# Plot all smooth
plot(1,type='n',xlim=c(myr,0),ylim=c(0,max(event_all_cons$N)),xlab='Ma', ylab='N', main="All events (consensus)")
lines(spline(event_all_cons$Ma-1, event_all_cons$N), type="l", col="red", lwd=5, pch=16, cex=1)
lines(spline(Af2Ar_all_cons$Ma-1, Af2Ar_all_cons$N), type="l", col="green", lwd=5, pch=16, cex=1)
lines(spline(Ar2Af_all_cons$Ma-1, Ar2Af_all_cons$N), type="l", col="purple", lwd=5, pch=16, cex=1)
lines(spline(vicariance_all_cons$Ma-1, vicariance_all_cons$N), type="l", col="gold", lwd=5, pch=16, cex=1)
lines(spline(extirp_from_Af_all_cons$Ma-1, extirp_from_Af_all_cons$N), type="l", col="blue", lwd=5, pch=16, cex=1)
lines(spline(extirp_from_Ar_all_cons$Ma-1, extirp_from_Ar_all_cons$N), type="l", col="orange", lwd=5, pch=16, cex=1)
...
#plot(1,type='n',xlim=c(myr,0),ylim=c(0,max(event_all_cons$N)+2),xlab='Ma', ylab='N', main="All events (consensus)")
#lines(smooth.spline(event_all_cons$Ma-1, event_all_cons$N, spar=0.2), type="l", col="red", lwd=5, pch=16, cex=1)
#lines(smooth.spline(Af2Ar_all_cons$Ma-1, Af2Ar_all_cons$N, spar=0.2), type="l", col="green", lwd=5, pch=16, cex=1)
#lines(smooth.spline(Ar2Af_all_cons$Ma-1, Ar2Af_all_cons$N, spar=0.2), type="l", col="purple", lwd=5, pch=16, cex=1)
#lines(smooth.spline(vicariance_all_cons$Ma-1, vicariance_all_cons$N, spar=0.2), type="l", col="gold", lwd=5, pch=16, cex=1)
#lines(smooth.spline(extirp_from_Af_all_cons$Ma-1, extirp_from_Af_all_cons$N, spar=0.2), type="l", col="blue", lwd=5, pch=16, cex=1)
#lines(smooth.spline(extirp_from_Ar_all_cons$Ma-1, extirp_from_Ar_all_cons$N, spar=0.2), type="l", col="orange", lwd=5, pch=16, cex=1)
#legend("topleft", legend=legend_text, fill=legend_colors, bty="n")
...
Af2Ar_stacked <- cbind(Af2Ar_all_cons, group="Af2Ar", group2="disp")
Ar2Af_stacked <- cbind(Ar2Af_all_cons, group="Ar2Af", group2="disp")
vic_stacked <- cbind(vicariance_all_cons, group="vic",group2="vic")
extAf_stacked <- cbind(extirp_from_Af_all_cons, group="extAf", group2="ext")
extAr_stacked <- cbind(extirp_from_Ar_all_cons, group="extAr", group2="ext")
data <- rbind(Af2Ar_stacked, Ar2Af_stacked, vic_stacked)
data2 <- rbind(Af2Ar_stacked, Ar2Af_stacked, vic_stacked, extAf_stacked, extAr_stacked)
data_disp <- rbind(Af2Ar_stacked, Ar2Af_stacked)

ggplot(data_disp, aes(x=Ma, y=N, fill=group)) +
  geom_area() +
  geom_vline(xintercept = 20, size=20, color = "blue", alpha = 0.4)
?geom_vline

ggplot(data, aes(x=Ma, y=N, fill=group)) +
  geom_area()
ggplot(data, aes(x=Ma, y=N, fill=group2)) +
  geom_area()

ggplot(data2, aes(x=Ma, y=N, fill=group)) +
  geom_area()
ggplot(data2, aes(x=Ma, y=N, fill=group2)) +
  geom_area()
...
sims_consensus_letters$Varanus[[25]]
...
#               sims_consensus_letters[[i]][[s]][as.phylo(consensus_genera[[i]])$edge[,2][as.phylo(consensus_genera[[i]])$edge[,1]==j]][1],
#               sims_consensus_letters[[i]][[j]][as.phylo(consensus_genera[[i]])$edge[,2][as.phylo(consensus_genera[[i]])$edge[,1]==j]][2])
#        if (list(v) %in% dispersal_Af2Ar){
#          Af2Ar_SIM_nodes_list_cons[[i]][[s]] <- append(Af2Ar_SIM_nodes_list_cons[[i]][[s]], j)
#        }
#        if (list(v) %in% dispersal_Ar2Af){
#          Ar2Af_SIM_nodes_list_cons[[i]][[s]] <- append(Ar2Af_SIM_nodes_list_cons[[i]][[s]], j)
#        }
#        if (list(v) %in% vicariance){
#          vicariance_SIM_nodes_list_cons[[i]][[s]] <- append(vicariance_SIM_nodes_list_cons[[i]][[s]], j)
#        }
#        if (list(v) %in% extirpation_from_Af){
#          extirpfromAf_SIM_nodes_list_cons[[i]][[s]] <- append(extirpfromAf_SIM_nodes_list_cons[[i]][[s]], j)
#        }
#        if (list(v) %in% extirpation_from_Ar){
#          extirpfromAr_SIM_nodes_list_cons[[i]][[s]] <- append(extirpfromAr_SIM_nodes_list_cons[[i]][[s]], j)
#        }
